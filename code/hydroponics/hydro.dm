...
/obj/item/weapon/reagent_containers/food/snacks/grown/killertomato/act_self(src)
	if(istype(usr.loc,/turf/space))
		return
	new /mob/living/simple_animal/tomato(usr.loc)
	usr << "<span class='notice'>You plant the killer-tomato.</span>"
	del(src)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/mushroom/walkingmushroom/act_self(src)
	if(istype(usr.loc,/turf/space))
		return
	new /mob/living/simple_animal/hostile/mushroom(usr.loc)
	usr << "<span class='notice'>You plant the walking mushroom.</span>"
