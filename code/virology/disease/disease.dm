...
/datum/disease
	...
	var/mob/human/affected_mob = null //the mob which is affected by disease.
...
/datum/disease/proc/spread(var/atom/source=null)
	...
	for(var/mob/human/M in oview(check_range, source))	//I have no idea why oview works when oviewers doesn't.	-Pete
