var/global/list/chemical_reactions_list = list(/datum/chemical_reaction/homunculinus)//list of all /datum/chemical_reaction datums. use during chemical reactions
